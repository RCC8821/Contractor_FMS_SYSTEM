...
} from "../../features/Payment/BiLL_Checked_BY_AshokSir_Slice";
import { Pencil, X } from "lucide-react";

const BiLL_Checked_BY_AshokSir = () => {
  ...
  const handleSave = async () => {
    ...
    const payload = {
      ...
      status7: status,     // Column AK
      remark7: remark,     // Column AM
    };
            ...
            <table className="w-full border-collapse text-sm">
              <thead>
                <tr className="bg-gray-800 text-white">
                  ...
                  <th className="border border-gray-300 px-4 py-4 text-left font-bold uppercase">Work Oder PDF</th>
...
export default BiLL_Checked_BY_AshokSir;